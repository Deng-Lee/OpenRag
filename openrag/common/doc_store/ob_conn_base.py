...
def escape_sql_literal(value: str) -> str:
    """Escape a value for use inside single-quoted SQL literals (OceanBase / MySQL-style)."""
...
doc_meta_columns = [
    Column("id", String(256), primary_key=True, comment="document id"),
...
def get_value_str(value: Any) -> str:
    ...
    if isinstance(value, str):
        ...
        return f"'{escape_sql_literal(json_str)}'"
    else:
        return str(value)
